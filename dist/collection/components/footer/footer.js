    ...
    render() {
        ...
        return (h("div", { class: {
            ...
            h("div", { class: 'copy' },
                ...
                h("p", null, copy)),
            h("div", { class: 'sections' }, section.sort((a, b) => a.position - b.position).map(({ title, link }) => (h("div", { class: 'section' },
                h("h3", null, title),
                link.sort((a, b) => a.position - b.position).map(({ url, title }) => (h("a", { href: url }, title)))))))));
    }
    static get is() { return "tok-footer"; }
